...
import { Clock, Calendar, MapPin, User, Users, Globe, Play, Ticket, AlertCircle, Film } from "lucide-react"
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          <div className="bg-white shadow-lg rounded-2xl p-8 flex flex-col items-center justify-center min-w-[400px] relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-gray-700 mb-2">Đang tải thông tin phim</h3>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          <div className="bg-white shadow-lg rounded-2xl p-8 flex flex-col items-center justify-center min-w-[400px] relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Không tìm thấy phim</h3>
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          <div className="bg-white shadow-lg rounded-2xl p-8 flex flex-col items-center justify-center min-w-[400px]">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Không tìm thấy phim</h3>
            <p className="text-gray-500 text-center mb-6">Phim bạn tìm kiếm không tồn tại</p>
            <button
                onClick={() => navigate(-1)}
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">{movie.name}</h2>
                    ...
                    <div className="mb-6">
                      ...
                      <span className="ml-3 font-semibold text-gray-700 text-lg">{ageLimit(movie.ageLimit)}</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-gray-50 rounded-lg p-3 flex items-center space-x-2">
                        ...
                        <span className="font-medium text-gray-700">{movie.duration} phút</span>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3 flex items-center space-x-2">
                        <Calendar className="h-5 w-5 text-gray-500" />
                        <span className="font-medium text-gray-700">{formatDate(movie.releaseDate)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    {movie.trailerUrl && (
                        <a
                            ...
                            className="flex items-center justify-center px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 group"
                        >
              ...
              {movie.description && (
                  <div className="mt-8 pt-8 border-t border-gray-200">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Nội dung phim</h3>
