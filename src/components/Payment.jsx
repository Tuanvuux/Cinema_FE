...
import { paymentOptions } from "../constants/constant";
...
const Payment = () => {
  ...
  const [timeLeft, setTimeLeft] = useState(59 * 2); // 2 phút
  ...
  useEffect(() => {
    const duration = 59 * 2 * 1000; // 2 phút = 120000 ms
  ...
  const handlePayment = async () => {
    ...
    try {
      if (paymentMethod === "momo") {
        ...
        setToastType("info");
        setToastMessage("Phương thức thanh toán chưa hỗ trợ!");
        setShowToast(true);
      }
    } catch (error) {
          ...
          >
            <div className="flex items-center justify-center space-x-3">
              ...
              <div className="text-center">
                ...
                >
                  {isTimeExpired ? "00:00" : formatTime(timeLeft)}
                </p>
              </div>
            </div>
            {isTimeExpired && (
              <div className="mt-3 text-center">
                <p className="text-sm text-red-600">
                  Phiên thanh toán đã hết hạn. Vui lòng chọn ghế lại để tiếp
                  tục.
                </p>
              </div>
            )}
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">
                            {showtime?.room?.name || "Không xác định"}
                          </p>
                        </div>
                      </div>
