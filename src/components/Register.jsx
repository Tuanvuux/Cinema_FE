        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Tạo tài khoản mới để trải nghiệm dịch vụ của chúng tôi</p>
            </div>
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg">
                      ...
                      <ul className="text-xs text-gray-500 space-y-1">
                        <li className={`flex items-center ${formData.password.length >= 6 ? "text-green-600" : ""}`}>
                          <div
                              className={`w-1.5 h-1.5 rounded-full mr-2 ${formData.password.length >= 6 ? "bg-green-500" : "bg-gray-300"}`}
                          ></div>
                          Ít nhất 6 ký tự
                        </li>
                        <li
                            className={`flex items-center ${formData.password && formData.confirmPassword && formData.password === formData.confirmPassword ? "text-green-600" : ""}`}
                        >
                          <div
                              className={`w-1.5 h-1.5 rounded-full mr-2 ${formData.password && formData.confirmPassword && formData.password === formData.confirmPassword ? "bg-green-500" : "bg-gray-300"}`}
                          ></div>
            ...
            {isCodeSent && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Xác thực tài khoản</h3>
