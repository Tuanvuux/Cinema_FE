          ...
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="seat-container overflow-x-auto pb-4">
                  <div className="min-w-max">
                    {seatMatrix.map((row, rowIndex) => {
                      ...
                      const isCoupleSeatRow = actualSeats.some(
                        (seat) => seat?.seatInfo?.name === "COUPLE"
                      );

                      return (
                        <div
                          key={rowIndex}
                          className="seat-row flex items-center mb-3"
                        >
                          {/* Row label */}
                ...
                <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3 flex items-center text-blue-800">
                  <Info className="w-5 h-5 mr-2 flex-shrink-0" />
                  <p className="text-sm">
                    Ghế đã chọn sẽ được giữ trong vòng{" "}
                    <span className="font-bold">3 phút</span>. Vui lòng hoàn tất
