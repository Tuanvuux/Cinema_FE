...
export default function Navbar() {
  ...
  const getLinkClasses = (path) => {
    const baseClasses =
      "relative px-3 py-2 rounded-lg transition-all duration-300 hover:text-yellow-400";
  ...
  const getMobileLinkClasses = (path) => {
    const baseClasses =
      "block px-4 py-3 rounded-lg transition-all duration-300 hover:text-yellow-400 hover:bg-white/5";
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <div className="space-y-1">
            ...
            <Link
              to="/showtime"
              className={getMobileLinkClasses("/showtime")}
              onClick={closeMenu}
            >
              Lịch chiếu
            </Link>
            <Link
              to="/movie"
              className={getMobileLinkClasses("/movie")}
              onClick={closeMenu}
            >
              Phim
            </Link>
            <Link
              to="/promotion"
              className={getMobileLinkClasses("/promotion")}
              onClick={closeMenu}
            >
              Ưu đãi
            </Link>
            ...
            <Link
              to="/member"
              className={getMobileLinkClasses("/member")}
              onClick={closeMenu}
            >
              Thành viên
            </Link>
