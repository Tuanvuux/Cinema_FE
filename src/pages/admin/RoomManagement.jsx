...
export default function RoomManagement() {
  ...
  const handleDeleteRoom = async (roomId) => {
    try {
      ...
      setRooms((prevRoom) => prevRoom.filter((room) => room.id !== roomId));
      setToast({
        show: true,
      ...
      <div className="flex h-full">
        ...
        <div className="flex-1 p-6 overflow-auto">
          ...
          <div className="flex justify-between mb-6">
            ...
            <button
              className={`${
                selectedRooms.length > 0 ? "bg-red-600" : "bg-gray-400"
                      ...
                      <input
                        ...
                        checked={
                          ...
                          (currentRooms.length > 0 &&
                            currentRooms.every((room) =>
                              currentRooms.includes(room.id)
                            ))
                        }
      ...
      {bulkDeleteModalOpen && (
        <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <p className="mb-6">
              Bạn có chắc chắn muốn xóa {selectedRooms.length} phòng chiếu đã
              chọn không?
            </p>
            <div className="flex justify-end gap-4">
              <button
                ...
                <div className="flex items-center space-x-4">
                  <label className="inline-flex items-center relative cursor-pointer">
                    <input
                      ...
                      onChange={() =>
                        setNewRoom({ ...newRoom, status: "ACTIVE" })
                      }
                      className="absolute opacity-0 cursor-pointer"
                    />
                    <div
                  ...
                  <label className="inline-flex items-center relative cursor-pointer">
                    <input
                      ...
                      onChange={() =>
                        setNewRoom({ ...newRoom, status: "INACTIVE" })
                      }
                      className="absolute opacity-0 cursor-pointer"
                    />
                    <div
